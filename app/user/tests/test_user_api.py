...
class PublicUserApiTest(TestCase):
    ...
    def test_create_valid_user_success(self):
        ...
        payload = {
            'email': 'fucked_up_test@example.com',
    ...
    def test_create_token_for_user(self):
        ...
        payload = {'email': 'test@sdfad1.com', 'password': 'testpass22'}
        create_user(**payload)
    ...
    def test_create_token_invalid_creadentials(self):
        ...
        create_user(email='test@example.com', password='testpass22')
        payload = {'email': 'test@sdfad.ru', 'password': 'wrong'}
        res = self.client.post(TOKEN_URL, payload)
    ...
    def test_create_token_no_user(self):
        ...
        payload = {'email': 'test@sdfad2.com', 'password': 'testpass22'}
        res = self.client.post(TOKEN_URL, payload)
    ...
    def test_create_token_missing_field(self):
        """Testthat email and password are  required"""
...
class PrivateUserAPITests(TestCase):
    """Test API that reqire authentication"""

    def setUp(self):
        self.user = create_user(
            email='test22233@example.com',
            password='testpassword2',
            name='name'
        )
    ...
    def test_update_user_profile(self):
        ...
        payload = {'name': 'New Name', 'password': 'passworsdfasdfa'}
