...
class PrivateIngredientApiTests(TestCase):
    ...
    def test_create_ingredient_successful(self):
        """Test that ingredient is create successfully"""
    ...
    def test_create_ingredient_invalid_user(self):
        """Test that invalid ingredient fails"""
        payload = {'name': ''}
        res = self.client.post(INGREDIENTS_URL, payload)

        self.assertEqual(res.status_code, status.HTTP_400_BAD_REQUEST)

    def test_retrieve_ingredients_assigned_to_recepiest(self):
