...
from recipe.serializers import RecipeSerializer, RecepieDetailSerializer
...
def image_upload_url(recipe_id):
    """Return url for a recipe image upload"""
...
class PrivateRecipeApiTestCase(TestCase):
    ...
    def test_view_recepie_detail(self):
        ...
        recepie = sample_recipe(user=self.user)
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        """Test returning recipes with specifict tags"""
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        recipe2 = sample_recipe(user=self.user, title='Chicken with stuff')
